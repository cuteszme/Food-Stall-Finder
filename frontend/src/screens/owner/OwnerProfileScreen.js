    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.userInfo}>
          ...
          <Text style={styles.userType}>Food Stall Owner</Text>
        </View>
      </View>
      ...
      {isEditing ? (
        ...
        <>
          ...
          <List.Section>
            ...
            <List.Item
              title="Food Stall Management"
              description="Add, edit, or remove your food stalls"
              left={props => <List.Icon {...props} icon="store" />}
              onPress={() => navigation.navigate('My Stalls')}
            />
            ...
            <List.Item
              ...
              onPress={() => {/* Navigate to business hours */}}
            />
